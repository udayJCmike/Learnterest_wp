...
{
    public partial class MyFavourites : PhoneApplicationPage
    {
        public MyFavourites()
        {
            InitializeComponent();
        ...
        {
            NavigationService.Navigate(new Uri("/CourseDetail.xaml", UriKind.Relative));
        }
        ...
        {
            MessageBoxResult result = MessageBox.Show("Are you sure want to remove this course from your favourites?", "Remove", MessageBoxButton.OKCancel);
            if (result == MessageBoxResult.OK)
            {
                MessageBox.Show("Course removed from favourites.");
            }
